...
\lstinputlisting[language=XML,belowcaptionskip=5pt,frame=bt,caption=XML Struktur des DatatypeProperty Tags,label=lst:dtprop]{extra/datatypeproperty.xml}
...
\lstinputlisting[language=XML,belowcaptionskip=5pt,frame=bt,caption=XML Struktur des Class Tags,label=lst:class]{extra/class.xml}
...
\lstinputlisting[language=XML,belowcaptionskip=5pt,frame=bt,caption=XML Struktur des NamedIndividual Tags,label=lst:indiv]{extra/namedindividual.xml}
...
\lstinputlisting[language=XML,belowcaptionskip=5pt,frame=bt,caption=XML Struktur des Pseudostate,label=lst:pseudo]{extra/pseudostate.xml}
...
\lstinputlisting[language=XML,belowcaptionskip=5pt,frame=bt,caption=XML Struktur des ActionState,label=lst:action]{extra/actionstate.xml}
...
\lstinputlisting[language=XML,belowcaptionskip=5pt,frame=bt,caption=XML Struktur des Pseudostate,label=lst:final]{extra/finalstate.xml}
...
\lstinputlisting[language=csh,belowcaptionskip=5pt,frame=bt,caption=Methoden um den Wizard zu beschreiben]{extra/wizard.txt}
