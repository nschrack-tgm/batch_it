...
Die Ontologie wird als XML exportiert. Diese XML Datei ist auf den Standards \ac{OWL} und \ac{RDF} aufgebaut, welche die Struktur und Aufteilung der abgebildeten Elemente vorgeben.\\
...
Das Aktivitätsdiagramm wird als XML exportiert. Diese XML Datei ist auf dem Standard \ac{XMI} aufgebaut, in welchem der \ac{UML} Standard integriert ist.\\
