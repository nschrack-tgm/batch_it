...
\end{figure}
	...
	\lstinputlisting[language=c,belowcaptionskip=5pt,frame=bt,caption=Prozedur]{extra/send_status.txt}
...
\end{figure}
	...
	Zusätzlich werden wiederum zwei weitere Parameter (Status, Command) zum Weiterschalten benötigt.\\\\
...
Die Prozedur ist somit fertig erstellt worden. In der Oberfläche wird anschließend angeboten, eine Rezeptur aus einer oder mehreren Grundfunktionen zu erstellen.

\begin{figure}[h!]
  \centering
  \includegraphics[height=0.6\textwidth]{graphics/implementation/rezept}
  \caption{Einfaches Rezept}
  \label{fig:rezept}
\end{figure}

Zusammengefasste Grundfunktionen (Rezepte) können weiteres in der erstellten Form inklusive zusätzlicher Informationen abgespeichert werden.
