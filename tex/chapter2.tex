...
\chapter{State of the Art} \label{chapter:stateoftheart}
	...
	Es ist gängige Praxis in der Anlagen- \& Verfahrenstechnik, vor Realisierung der Anlage eine schematische Darstellung dieser zu modellieren. Das Rohr- \& Instrumentenfließschema ist hierfür ein probates Mittel, ein vollständiges Abbild dieser zu erstellen. Die verwendeten Bauteile sind jedenfalls namentlich beschriftet, können aber auch zusätzliche Informationen, die zum Verständnis der Verwendung beitragen, beinhalten.\\
